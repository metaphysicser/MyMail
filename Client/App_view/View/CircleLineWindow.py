"""
-*- coding: utf-8 -*-
@Time    : 2022/1/10 15:07
@Author  : 夕照深雨
@File    : CircleLineWindow.py
@Software: PyCharm
...
backgroundColor = QColor(0, 170, 255)
backgroundMlt = 0.85
...
class CircleLineWindow(Window):
    ...
    def draw(self, painter, circleExp=None, circleExpSp=None):
        if circlePulse:
